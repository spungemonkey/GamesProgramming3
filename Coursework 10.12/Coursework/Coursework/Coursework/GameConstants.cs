...
namespace Lab5
{
    static class GameConstants
    {
        ...
        public const float DFGSpeedAdjustment = 2.5f; //Determines what speed the
        ...
        //bullet constants
        public const int NumBolts = 1; //Total number of bolts
        public const float LaserSpeedAdjustment = 7.0f; //speed of the bolts
        public const float LaserScalar = 8.0f; //bolt scale for the models
