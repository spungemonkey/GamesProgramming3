...
namespace Lab5
{
    ...
    public class Game1 : Microsoft.Xna.Framework.Game
    {
        ...
        private void gameControls()
        {
            ...
            //are we shooting?
            if (keyboardState.IsKeyDown(Keys.Space) || lastState.IsKeyDown(Keys.Space) || GamePad.GetState(PlayerIndex.One).Buttons.A == ButtonState.Pressed)
            {
                DateTime startVib;
                TimeSpan endVib;
            ...
            if (keyboardState.IsKeyDown(Keys.D1) || GamePad.GetState(PlayerIndex.One).Buttons.Y == ButtonState.Pressed)
            {
        ...
        private void moveBoss(float delta)
        {
            ...
            BoundingSphere bossSphere = new BoundingSphere(bossPos, mdlBoss.Meshes[0].BoundingSphere.Radius * 0.08f);
...
/*
FIX VIBRATION
FIX CAMERA CHANGE SO IT DOES IT ONCE PER PRESS
FIX CAMERA SO WE CAN CONTROL IT ON THUMBSTICK
FIX TEXTURES
TOGGLE SOUNDS
*/